...
Verify that all protocol objects have a unique canonical serialization.
...
Both serializations MUST be byte-identical. JSON Schema validation against APS-200 schemas MUST pass for all objects.
